...
- (void)layoutSubviews {
    ...
    self.showPwdButtoon.frame = CGRectMake(self.frame.size.width - kButtonSize, 0, kButtonSize, kButtonSize);
}
...
{
    return CGRectOffset([super clearButtonRectForBounds:bounds], -kButtonSize, 0);
}
