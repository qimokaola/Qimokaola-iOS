...
#define kCollectedCoursesHeaderTitle @"★ 我的课程"
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.collectBlock = ^(BOOL newCollectedStatus) {
        if (newCollectedStatus) {
            ...
            [ZWHUDTool showHUDInView:weakSelf.navigationController.view withTitle:@"该课程已收藏置顶" message:nil duration:kShowHUDMid];
        } else {
