...
- (IBAction)addCountDown:(id)sender {
    ...
    controller.completion = ^(ZWCountdown *countdown) {
        ...
        [ZWHUDTool showHUDInView:weakSelf.navigationController.view withTitle:@"添加成功" message:nil duration:kShowHUDMid];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    controller.completion = ^(ZWCountdown *countdown) {
        ...
        [ZWHUDTool showHUDInView:weakSelf.navigationController.view withTitle:@"修改成功" message:nil duration:kShowHUDMid];
        weakSelf.countdowns = [[ZWCountdownDatabaseManager defaultManager] fetchCountdownList];
        [weakSelf.tableView reloadData];
    };
    [self.navigationController pushViewController:controller animated:YES];
