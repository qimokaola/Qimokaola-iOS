...
//    [[UMComDataRequestManager defaultManager] userLoginInUMCommunity:@"727489038@qq.com" password:@"lin727489038" response:^(NSDictionary *responseObject, NSError *error) {
//        [hud hideAnimated:YES];
//        if (error) {
...
//    [[UMComDataRequestManager defaultManager] userLoginWithName:@"昵称"
//                                                         source:UMComSnsTypeSina
//                                                       sourceId:@"1212121212"
//                                                       icon_url:@"http://dev.umeng.com/system/images/W1siZiIsIjIwMTYvMDYvMjAvMTNfNTFfMzBfODM2X0g1X2RlbW8ucG5nIl1d/H5%20demo.png"
//                                                         gender:10
//                                                            age:1 custom:@""
...
//                                                         
//                                                         if (error) {
//                                                             [UMComShowToas t showFetchResultTipWithError:error];
//                                                         } else {
//                                                             [UMComShowToast accountLoginSuccess];
//                                                         }
//                                                     }];
