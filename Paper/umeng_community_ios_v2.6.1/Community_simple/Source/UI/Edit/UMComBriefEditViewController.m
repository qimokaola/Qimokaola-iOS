...
-(void) createBackgroudBtn
{
    ...
    self.backgroudBtn.backgroundColor = UMComColorWithColorValueString(@"#F6f7f9");
...
-(void) createTopicLabel
{
    ...
    self.topicLabel.textColor = UMComColorWithColorValueString(@"#999999");
...
//@property (nonatomic,readwrite,strong)UMComBriefEditView* briefeditView;
...
-(void) dealloc
{
    //NSLog(@"UMComBriefEditViewController_dealloc");
}
...
-(void) createNavigationItems
{
    ...
    [backBtn setTitleColor:UMComColorWithColorValueString(@"#F6f7f9") forState:UIControlStateNormal];
    ...
    [postBtn setTitleColor:UMComColorWithColorValueString(@"#469ef8") forState:UIControlStateNormal];
    [postBtn setTitleColor:[UIColor grayColor] forState:UIControlStateHighlighted];
    
    postBtn.backgroundColor = UMComColorWithColorValueString(@"#F6F7F9");
...
-(void) handlePostBtn:(id)target
{
   ...
   // 检查内容的最大长度
    ...
    //准备发送请求
//    NSNumber* atype = [UMComSession sharedInstance].loginUser.atype;
//    if ([atype isKindOfClass:[NSNumber class]] && atype.integerValue == 1) {
    ...
    /*
    NSMutableArray* topics =  [NSMutableArray arrayWithCapacity:2];
    if (self.topic && self.topic.topicID) {
        [topics addObject:self.topic.topicID];
    }
    ...
    [UMComCreateFeedDataController feedCreateWithContent:self.briefeditView.text title:nil location:nil locationName:nil related_uids:nil topic_ids:topics images:self.originImages type:nil custom:nil completion:^(id responseObject, NSError *error) {
...
-(void) doPostWithType:(UMComCreateFeedType)type
{
    ...
    [UMComCreateFeedDataController feedCreateWithContent:self.briefeditView.text title:nil location:nil locationName:nil related_uids:nil topic_ids:topics images:self.originImages type:@(type) custom:nil completion:^(id responseObject, NSError *error) {
        [hud hideAnimated:YES];
        [UIApplication sharedApplication].networkActivityIndicatorVisible = NO;
        if (responseObject && [responseObject isKindOfClass:[UMComFeed class]] && !error) {
            [weakself dealWhenPostFeedFinish:@[responseObject] error:error];
...
-(void) createBackgroudScrollView
{
    ...
    self.backgroudScrollView.backgroundColor = UMComColorWithColorValueString(@"#e8eaee");
...
-(void) createSeparateLineBelowSelectedTopicionView
{
    ...
    separateLine.backgroundColor = UMComColorWithColorValueString(@"#dfdfdf");
...
-(void) createBriefEditView
{
    ...
    //briefeditViewBackgroud.backgroundColor = UMComColorWithColorValueString(@"#f6f7f9");
...
-(void) createMenuView
{
    ...
    //self.menuView.backgroundColor= UMComColorWithColorValueString(@"#f6f7f9");
...
-(void) createTipAddImage
{
    ...
    self.tipAddImageBackGroud.backgroundColor = UMComColorWithColorValueString(@"#F6F7F9");
    ...
    self.tipAddImage.textColor =UMComColorWithColorValueString(@"#666666");
...
-(void)viewsFrameChange
{
    ...
    //NSLog(@"self.view.height = %f,self.backgroudScrollView.height = %f",self.view.bounds.size.height,self.backgroudScrollView.contentSize.height);
}
